...
def compute_global_norm_stats(base_folder: Path = Path("maritime_domain_awareness/src/maritime_domain_awareness/done44"), train_frac: float = 0.7, IN_COLS = IN_COLS, DELTA_COLS = DELTA_COLS):
    """
